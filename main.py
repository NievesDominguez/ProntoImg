...
from utils.git_tools import subir_imagenes_a_github  
import os  
...
REPO_LOCAL_IMG = os.path.join(os.path.dirname(os.path.abspath(__file__)), "img")  
...
def cargar_desde_excel(ruta_excel):  
    ...
    imagenes_a_subir = []  # Lista para acumular imágenes a subir  
    ...
    # Subir todas las imágenes a GitHub
    if imagenes_a_subir:  
        subir_imagenes_a_github(  
            repo_destino=REPO_LOCAL_IMG,  
            rutas_imagenes=imagenes_a_subir,  
            mensaje_commit="Subida automática de imágenes"  
        )  
